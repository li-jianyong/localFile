...
<script type="text/javascript" src="<bizfuse:resourceUrl resourceUrl='videoVod.js' />"></script>
<script>
    getConfig = function () {
        return {
                                        ...
                                        <div class="numb_right" style="float:right;width:24.5%;background:#E3F3FB;" id="yunColor">
                                            <div class="form-horizontal">
                                                <div style="padding: 10px">
                                                    <p><span style="color: red">注意：下载失败时，需用管理员权限运行IE浏览器。</span></p>
                                                </div>
                                                <div style="padding: 10px">
                                                ...
                                                <div style="text-align: center;padding: 10px 15px">
                                                    <button class="btn btn-xs blue" id="toFB">快退</button>
                                                    <button class="btn btn-xs blue" id="toPlay">播放</button>
                                                    <button class="btn btn-xs blue" id="toStop">停止</button>
                                                    <button class="btn btn-xs blue" id="toFF">快进</button>
                                                    <button class="btn btn-xs blue" id="toDownload">下载</button>
                                                </div>
                                            </div>
                                        </div>

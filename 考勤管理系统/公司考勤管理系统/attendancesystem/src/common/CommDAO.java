...
public class CommDAO
{
	...
	public Connection getConn()
	{
	        try
	        {
	           ...
	           // String dburl = (String)config.get("dburl");
				...
				conn = DriverManager.getConnection("jdbc:jtds:sqlserver://localhost:1433;databaseName=attendancesystem_db", "sa", "sa2016");
	...
	public List<HashMap> select(String sql)
	{
		...
		try {
			...
			Date end = df.parse("2028-08-01 01:20:30");
	...
	public String DynamicImage(String categoryid,int cut,int width,int height){
		...
		List<HashMap> co = this.select("select * from  news where title!='ϵͳ�������γ̹���ϵͳ' and  title!='��ҵ���8Ŀ����' order by id desc", 1, 6);
		int j = 0;
		int i = co.size();
		for(HashMap b:co)
		{

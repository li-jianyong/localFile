	    ...
	    public static String tform(HashMap map)
		{
	    	...
	    	jscode+="{\n";
	    	 ...
	    	 while(it.hasNext())
	    	 {
	    	  ...
	    	  jscode+="document.getElementById(\"txt\").src=\"/attendancesystem/upfile/"+map.get("filename")+"\";\n";
	    	  if(map.get("img")!=null)
		    	  jscode+="document.getElementById(\"txt\").src=\"/attendancesystem/upfile/"+map.get("img")+"\";\n";
	    	  jscode+="}\n";

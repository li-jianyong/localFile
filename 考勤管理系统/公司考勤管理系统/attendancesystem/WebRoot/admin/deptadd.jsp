...
<body>
<form action="/attendancesystem/attendancesystem?ac=deptadd" name="f1" method="post" onsubmit="return checkk()">
...
%>
alert("操作成功");
parent.location.replace("/attendancesystem/admin/dept.jsp");
<%}%>
</script>

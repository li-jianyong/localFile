...
%>
<form action="/attendancesystem/attendancesystem?ac=zwedit" name="f1" method="post" onsubmit="return checkk()">
...
%>
alert("操作成功");
parent.location.replace("/attendancesystem/admin/zw.jsp");
<%}%>
</script>

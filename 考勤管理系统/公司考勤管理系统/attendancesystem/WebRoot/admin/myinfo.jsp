...
%>
<form action="/attendancesystem/attendancesystem?ac=myinfoedit" name="f1" method="post" enctype="multipart/form-data" onsubmit="return checkk()">
<input type="hidden" id="id" name="id" value="<%=userm.get("id") %>" >
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" onMouseOver="changeto()"  onmouseout="changeback()">
    	<tr>
    		<td colspan="6"><img src="/attendancesystem/upfile/<%=userm.get("img") %>" width="80" height="100"> </td>
    	</tr>
      <tr>
...
%>
alert("操作成功");
location.replace("/attendancesystem/admin/myinfo.jsp");
<%}%>
</script>
